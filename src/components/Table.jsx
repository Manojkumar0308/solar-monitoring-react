...
const columns = [
  { field: 'id', headerName: 'ID', width: 90,headerClassName: 'table-header', headerAlign: 'center', },
  {
    field: 'siteId',
    headerName: 'Site-Id',
    width: 150,
...
const rows = [
  ...
  { id: 2, siteId: 'S124', siteName: 'MJSH Plant', email: 'site2@example.com', contact: '9876543210', address: 'Plot-12335, abc nagar, abc Road', city: 'Noida', status: 'Active', createdAt: new Date() },
  ...
  { id: 7, siteId: 'S129', siteName: 'MJSH Plant', email: 'site7@example.com', contact: '2583691470', address: 'Plot-12340, abc nagar, abc Road', city: 'Noida', status: 'Active', createdAt: new Date() },
  ...
  { id: 11, siteId: 'S133', siteName: 'MJSH Plant', email: 'site11@example.com', contact: '9638527410', address: 'Plot-12344, abc nagar, abc Road', city: 'Noida', status: 'Active', createdAt: new Date() },
...
export default function DataGridDemo({ isSidebarOpen, toggleSidebar, setActiveTab, showMobNavBar, activeTab }) {
  ...
  return (
    <div className=" flex flex-col">
      ...
      <Box sx={{ width: '100%' }} className="mt-8 px-8">
